...
function initialize_heavy_species_default!(U, params; min_ion_density = 2e17, max_ion_density = 1e18)
...
function initialize_electrons_default!(params; max_electron_temperature = -1.0)
    ...
    Te_max = max_electron_temperature > 0.0 ? max_electron_temperature : config.discharge_voltage / 10 
    Te_width = L_ch/3
