...
function plot_solution(u, z = nothing, case = 1)
    ...
    p_ϵ  = plot_quantity(u[5, :], z; title = "Electron energy (eV)", ylabel = "ϵ (eV)", ref_path = "landmark/landmark_electron_temperature_$(case).csv")
...
function plot_solution_real(u, z = nothing, case = 1)
    ...
    p_ϵ  = plot_quantity(u[5, :], z; title = "Electron energy (eV)", ylabel = "ϵ (eV)", hallis = hallis, hallisvar = hallis.Te)
    p_ue = plot_quantity(u[10, :] ./ 1000, z; title = "Electron velocity", ylabel = "ue (km/s)")
