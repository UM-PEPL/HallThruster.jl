...
@testset "Array allocation" begin
    ...
    Xe_0 = HallThruster.Fluid(HallThruster.Xenon(0), 100.0, 100.0)
    Xe_I = HallThruster.Fluid(HallThruster.Xenon(1), T = 100.0)
    Xe_II = HallThruster.Fluid(HallThruster.Xenon(2), T = 100.0)
