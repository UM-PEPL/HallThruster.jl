...
function test_landmark_loading()
    @testset "Landmark data loading" begin
        ...
        _ = het.load_landmark_data(2, "fluid_1")
        _ = het.load_landmark_data(2, "fluid_2")
        _ = het.load_landmark_data(2, "hybrid")

        _ = het.load_landmark_data(3, "fluid_1")
        _ = het.load_landmark_data(3, "fluid_2")
        _ = het.load_landmark_data(3, "hybrid")
