using Symbolics
include("$(HallThruster.TEST_DIR)/order_verification/ovs_funcs.jl")
@testset "Order verification (electron energy)" begin
    include("$(HallThruster.TEST_DIR)/order_verification/ovs_energy.jl")
...
@testset "Order verification (neutrals and ions)" begin
    include("$(HallThruster.TEST_DIR)/order_verification/ovs_ions.jl")
