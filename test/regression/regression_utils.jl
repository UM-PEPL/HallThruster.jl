...
function check_regression_case(case)
    ...
    return @testset "$(file)" begin
        ...
        for (eff_name, eff_func) in efficiencies
            ...
            @test isapprox(eff_mean, eff_expected; rtol)
        end
        ...
        @test isapprox(max_Te, case.max_Te; rtol)
        @test isapprox(max_E, case.max_E; rtol)
        @test isapprox(max_nn, case.max_nn; rtol)
        @test isapprox(max_ni, case.max_ni; rtol)
    end
end
